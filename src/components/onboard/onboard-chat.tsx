      ...
      <header className="shrink-0 border-b border-border bg-card z-30">
        <div className="mx-auto flex h-14 max-w-2xl items-center gap-2.5 px-4 justify-between">
          <div className="flex items-center gap-2.5">
            <div className="flex h-8 w-8 items-center justify-center rounded-[5px] border border-border bg-background">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="mx-auto max-w-2xl px-4 py-12">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex h-16 w-16 items-center justify-center rounded-[6px] border border-border bg-card mb-4">
          ...
          {connected.length > 0 && (
            <div className="space-y-2 mb-6">
              {connected.map((ex) => (
                <div
                  key={ex.id}
                  className="flex items-center gap-3 rounded-[5px] border border-success/20 bg-success/5 px-4 py-3"
                >
          ...
          {/* Exchange form */}
          {showForm ? (
            <div className="rounded-[6px] border border-border bg-card p-7 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="flex h-10 w-full rounded-[5px] border border-border bg-background px-3 text-sm focus:border-[#333333] transition-all"
                >
                  {EXCHANGES.map((ex) => (
              ...
              {error && (
                <div className="rounded-[5px] border border-destructive/20 bg-destructive/5 p-3">
              ...
              <Button
                ...
                className="w-full gap-2 bg-foreground text-background hover:bg-foreground/90 border-0 h-11"
              >
                {loading ? (
          ...
          <div className="mt-8 flex flex-col items-center gap-3">
            <Button
              ...
              disabled={finishing}
              size="lg"
              className="gap-2 bg-foreground text-background hover:bg-foreground/90 border-0 px-8"
            >
              {finishing ? (
                <Loader2 className="h-4 w-4 animate-spin" />
              ) : (
